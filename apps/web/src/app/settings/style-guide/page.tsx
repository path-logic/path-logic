                    ...
                    <div className="space-y-4 flex flex-col justify-center">
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-foreground">
                                The word <span className="font-bold">Path</span> uses standard
                                foreground, while{' '}
                                <span className="text-primary font-bold">Logic</span> must use the
                                primary brand color.
                            </p>
                        </div>
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                ...
                                Prefer <span className="font-bold">tracking-tighter</span> or{' '}
                ...
                <div className="grid gap-8 border border-border/50 rounded-lg p-8 bg-muted/10">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                            ...
                            terminal-based productivity tools. Every pixel must serve a functional
                            purpose.
                        </p>
                    </div>
                    <div className="space-y-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Default container with premium soft shadows and rounded corners.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="p-4 bg-muted/30 rounded-md border border-border/50 text-xs text-muted-foreground italic">
                                &quot;Borders should be subtle (50% opacity) and shadows must use
                                multi-layered RGB values.&quot;
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card interactive accentColor="bg-blue-500">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Expands shadow and translates slightly upwards on hover.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
            ...
            <section className="space-y-6">
                ...
                <Card className="max-w-xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Forms should use consistent spacing and h-11 inputs.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                        ...
                        <div className="flex gap-3 pt-4">
                            ...
                            <Button className="flex-1 h-11 font-bold uppercase tracking-widest">
                                Submit Action
                            </Button>
                        </div>
                    </CardContent>
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <Card className="p-6 space-y-2">
                        ...
                        <Button
                            variant="outline"
                            className="w-full h-12 uppercase text-[10px] tracking-widest"
                        >
                            Button (Default)
                        </Button>
