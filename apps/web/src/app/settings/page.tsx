                    ...
                    <div className="mx-auto max-w-7xl w-full space-y-8">
                        <header className="flex justify-between items-center flex-none">
                            <div>
                                ...
                                <p className="text-muted-foreground text-[10px] uppercase font-bold tracking-widest">
                                    Configure your Path Logic experience and experiment with
                                    features
                                </p>
                            </div>
                        </header>
                        ...
                        <section className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {Object.values(FLAG_CONFIGS).map(
                                    (config: IFlagConfig): React.JSX.Element => (
                                        <Card
                                            key={config.key}
                                            className="py-0 border-border/40 overflow-hidden"
                                        >
                            ...
                            <Card className="p-6">
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center py-2 border-b border-border/30 last:border-0">
                                        ...
                                        <span className="text-[11px] font-black uppercase text-emerald-500">
                                            Local-First WASM SQLite
                                        </span>
                                    </div>
                                    <div className="flex justify-between items-center py-2 border-b border-border/30 last:border-0">
                                        <span className="text-[10px] font-bold uppercase text-muted-foreground tracking-widest">
