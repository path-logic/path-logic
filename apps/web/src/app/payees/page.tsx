...
export default function PayeesPage(): React.JSX.Element {
    ...
    const { payees, isInitialized, initialize } = useLedgerStore();
            ...
            <div className="w-full mx-auto space-y-4 pb-12">
                <header className="flex justify-between items-center flex-none">
                    ...
                    <Button
                        variant="outline"
                        size="sm"
                        className="font-bold text-[10px] uppercase h-8 border-primary/20 text-primary hover:bg-primary/10"
                    >
                            ...
                            payees.map((payee: IPayee) => (
                                ...
                                >
                                    <div
                                        ...
                                        onClick={(): void =>
                                            setExpandedId(expandedId === payee.id ? null : payee.id)
                                        }
                                    >
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-4">
                                                <div>
                                                    ...
                                                    <div className="space-y-1 text-[10px] font-bold uppercase">
                                                        ...
                                                        {payee.latitude && (
                                                            <p className="font-mono text-primary text-[9px] tracking-normal">
                                                                {payee.latitude}, {payee.longitude}
                                                            </p>
                                                        )}
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-col justify-end gap-2">
                                                    <Button
                                                        variant="outline"
                                                        size="sm"
                                                        className="text-[9px] uppercase font-black h-7"
                                                    >
                                                        Edit Payee
                                                    </Button>
                                                    <Button
                                                        size="sm"
                                                        className="bg-primary/10 hover:bg-primary/20 text-primary text-[9px] uppercase font-black h-7 border border-primary/20"
                                                    >
                                                        Transaction History
                                                    </Button>
                                                </div>
