                ...
                <div className="col-span-10 flex flex-col">
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex gap-2">
                            <button className="bg-[#38BDF8] text-[#0F1115] text-[10px] font-bold px-3 py-1 rounded-sm uppercase">
                                Import QIF
                            </button>
                            <button className="bg-[#1E293B] text-[#E2E8F0] text-[10px] font-bold px-3 py-1 rounded-sm uppercase">
                                Reconcile
                            </button>
                        </div>
                        <input
                        ...
                        <table className="w-full text-left border-collapse font-mono text-xs">
                            ...
                            <tbody className="divide-y divide-[#1E293B]">
                                {MOCK_TRANSACTIONS.map(tx => (
                                    ...
                                    >
                                        <td className="p-3 font-medium text-[#64748B]">
                                            {tx.date}
                                        </td>
                                        <td className="p-3">
