...
export function NewAccountDialog({
    ...
    onClose,
    onAccountCreated,
}: INewAccountDialogProps): React.JSX.Element {
            ...
            >
                <div className="p-6 border-b border-border bg-muted/30">
                    ...
                    <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest opacity-70">
                        {step === 'select-type'
                            ? 'Select the account classification'
                ...
                <div className="p-6">
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-2 gap-3">
                                {PRIMARY_TYPES.map(option => {
                                    ...
                                    const optTheme = TYPE_THEMING[option.type] || {
                                        accentBg: 'bg-primary',
                                    ...
                                    return (
                                        ...
                                        >
                                            <div
                                                className={cn(
                                                    'w-10 h-10 rounded-sm flex items-center justify-center mb-3 group-hover:scale-110 transition-transform',
                                                    optTheme.iconBg,
                                                )}
                                            >
                                                <Icon
                                                    className={cn('w-5 h-5', optTheme.iconText)}
                                                />
                                            </div>
                    ...
                    {step === 'enter-details' &&
                        selectedType &&
                        !TypeGuards.isLoanAccount(selectedType) && (
                            <div className="space-y-6">
                                <div className="flex gap-4 p-4 bg-muted/30 rounded-sm border border-border">
                                    <div
                                        className={cn(
                                            'w-12 h-12 rounded-sm flex items-center justify-center flex-none',
                                            theming?.iconBg,
                                        )}
                                    >
                                        {selectedOption && (
                                            <selectedOption.icon
                                                className={cn('w-6 h-6', theming?.iconText)}
                                            />
                                        )}
                                    </div>
                                    <div>
                                        <h3 className="text-[11px] font-black uppercase tracking-widest mb-0.5">
