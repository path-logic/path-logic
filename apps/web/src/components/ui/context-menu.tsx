...
function ContextMenuItem({
    ...
    return (
        <ContextMenuPrimitive.Item
            ...
            className={cn(
                "focus:bg-accent focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:bg-destructive/10 dark:data-[variant=destructive]:focus:bg-destructive/20 data-[variant=destructive]:focus:text-destructive relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-xs font-bold uppercase tracking-tight outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
                inset && "pl-8",
                className
            )}
            {...props}
...
function ContextMenuLabel({
    ...
    return (
        <ContextMenuPrimitive.Label
            ...
            data-inset={inset}
            className={cn(
                "text-foreground px-2 py-1.5 text-xs font-black uppercase tracking-widest opacity-50",
                inset && "pl-8",
                className
            )}
            {...props}
