...
import { Landmark, Banknote, CreditCard, Wallet, Plus, Search, Calendar } from 'lucide-react';
    ...
    return (
        <>
            ...
            <aside className="w-64 flex flex-col gap-4 flex-none overflow-hidden pr-2">
                <Card className="bg-card border-border rounded-sm h-full flex flex-col overflow-hidden">
                    <div className="px-4 py-3 flex justify-between items-center border-b border-border bg-muted/30">
                        <h2 className="text-xs text-muted-foreground font-bold uppercase tracking-widest">
                            Accounts
                        </h2>
                        <Link
                            href="/accounts"
                    ...
                    <ScrollArea className="flex-1">
                        <div className="p-2 space-y-1">
                            {accounts.map(
                                (acc: IAccount): React.JSX.Element => (
                    ...
                    <div className="p-2 border-t border-border bg-muted/20">
                        <Link
                            href="/recurring"
                            className="flex items-center gap-2 p-2 rounded-sm hover:bg-primary/10 transition-colors group"
                        >
                ...
                <Card className="bg-card border-border rounded-sm p-3 shadow-lg flex-none relative z-10">
                    <form onSubmit={handleQuickAdd} className="grid grid-cols-12 gap-3 items-end">
                        ...
                        <div className="col-span-2 flex gap-2">
                            <Button
                                type="submit"
                                className="flex-1 text-xs font-black uppercase h-7"
                            >
                                Record
                            </Button>
                            <Button
                ...
                <div className="flex items-center justify-between flex-none px-1">
                    <div className="flex gap-2">
                        <Button
                            ...
                            className="h-7 text-xs font-black uppercase bg-primary/10 border-primary/20 text-primary hover:bg-primary/20"
                        >
            ...
            <Dialog open={!!accountToDelete} onOpenChange={() => setAccountToDelete(null)}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle className="uppercase font-black tracking-widest text-destructive">
                            Confirm Account Deletion
                        </DialogTitle>
                        <DialogDescription className="text-xs uppercase font-bold text-muted-foreground">
                            Are you sure you want to delete this account? Transactions will be
                            retained for reporting, but the account will be hidden from the sidebar.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
            ...
            <Dialog open={!!accountToEdit} onOpenChange={() => setAccountToEdit(null)}>
                <DialogContent className="sm:max-w-[425px] md:max-w-[600px] border-border bg-card">
                    <DialogHeader>
                        <DialogTitle className="uppercase font-black tracking-widest text-primary">
